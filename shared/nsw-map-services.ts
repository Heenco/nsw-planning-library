...
export const MAP_SERVICES: MapService[] = [
  ...
  { id: 'administrative-boundaries-addresspoint', section: 'Administrative boundaries', name: "AddressPoint", url: 'https://maps.six.nsw.gov.au/arcgis/rest/services/public/NSW_Query/MapServer/0' },
  { id: 'administrative-boundaries-propertylot', section: 'Administrative boundaries', name: "PropertyLot", url: 'https://maps.six.nsw.gov.au/arcgis/rest/services/public/NSW_Property/MapServer/5' },
  ...
  { id: 'administrative-boundaries-poi', section: 'Administrative boundaries', name: "POI", url: 'https://maps.six.nsw.gov.au/arcgis/rest/services/public/NSW_POI/MapServer/0' },
