...
export const SOURCES: Record<string, DocumentSource> = {
  ...
  // ── Five more Sydney-region plans, chosen to differ from one another ──
  // Every reader in this pipeline was written against Parramatta and then broke on
  // the second council it met, so these span amalgamation plans, coastal and bush
  // fire, heritage, a growth area and dense urban rather than five of a kind.
  'canterbury-bankstown-lep': {
    label: 'canterbury-bankstown-lep',
    title: 'Canterbury-Bankstown Local Environmental Plan 2023',
    doc_type: 'lep',
    scope: 'local',
    hierarchy_level: 3,
    lga_name: 'Canterbury-Bankstown',
    source_url: 'https://legislation.nsw.gov.au/view/whole/html/inforce/current/epi-2023-0336',
    raw_path: path.join(REPO_ROOT, 'public', 'EPI', 'xml', 'epi-2023-0336.xml'),
    raw_format: 'xml',
    as_at_date: DEFAULT_AS_AT,
  },
  'sutherland-lep': {
    label: 'sutherland-lep',
    title: 'Sutherland Shire Local Environmental Plan 2015',
    doc_type: 'lep',
    scope: 'local',
    hierarchy_level: 3,
    lga_name: 'Sutherland Shire',
    source_url: 'https://legislation.nsw.gov.au/view/whole/html/inforce/current/epi-2015-0319',
    raw_path: path.join(REPO_ROOT, 'public', 'EPI', 'xml', 'epi-2015-0319.xml'),
    raw_format: 'xml',
    as_at_date: DEFAULT_AS_AT,
  },
  'ku-ring-gai-lep': {
    label: 'ku-ring-gai-lep',
    title: 'Ku-ring-gai Local Environmental Plan 2015',
    doc_type: 'lep',
    scope: 'local',
    hierarchy_level: 3,
    lga_name: 'Ku-ring-gai',
    source_url: 'https://legislation.nsw.gov.au/view/whole/html/inforce/current/epi-2015-0134',
    raw_path: path.join(REPO_ROOT, 'public', 'EPI', 'xml', 'epi-2015-0134.xml'),
    raw_format: 'xml',
    as_at_date: DEFAULT_AS_AT,
  },
  'the-hills-lep': {
    label: 'the-hills-lep',
    title: 'The Hills Local Environmental Plan 2019',
    doc_type: 'lep',
    scope: 'local',
    hierarchy_level: 3,
    lga_name: 'The Hills',
    source_url: 'https://legislation.nsw.gov.au/view/whole/html/inforce/current/epi-2019-0596',
    raw_path: path.join(REPO_ROOT, 'public', 'EPI', 'xml', 'epi-2019-0596.xml'),
    raw_format: 'xml',
    as_at_date: DEFAULT_AS_AT,
  },
  'inner-west-lep': {
    label: 'inner-west-lep',
    title: 'Inner West Local Environmental Plan 2022',
    doc_type: 'lep',
    scope: 'local',
    hierarchy_level: 3,
    lga_name: 'Inner West',
    source_url: 'https://legislation.nsw.gov.au/view/whole/html/inforce/current/epi-2022-0457',
    raw_path: path.join(REPO_ROOT, 'public', 'EPI', 'xml', 'epi-2022-0457.xml'),
    raw_format: 'xml',
    as_at_date: DEFAULT_AS_AT,
  },
  'parramatta-lep': {
